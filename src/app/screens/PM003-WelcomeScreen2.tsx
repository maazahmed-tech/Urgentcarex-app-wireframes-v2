...
export default function WelcomeScreen2({ onNext, onSkip }: WelcomeScreen2Props) {
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="w-[280px] h-[240px] bg-[#F3F4F6] rounded-2xl flex items-center justify-center mb-12">
          <div className="text-center">
            ...
            <div className="text-sm text-[#6B7280]">Map with pins showing doctors</div>
          </div>
        </div>
        ...
        <p className="text-base text-[#6B7280] text-center max-w-[280px] mb-12">
          We'll find doctors and facilities that match your symptoms, location, and insurance.
        </p>
